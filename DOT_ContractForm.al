...
page 50100 DOT_Contract
{
        ...
        area(navigation)
        {
            group("O&rder")
            {
                ...
                action("Co&mments")
                {
                    ...
                    RunPageLink = "Document Type" = CONST("Contract"),
                                  "No." = FIELD("No."),
    ...
    var
        ...
        DocType: Option Quote,"Order",Invoice,"Credit Memo","Contract","Return Order",Reminder,FinChMemo;
    begin
        DocNoVisible := DocumentNoVisibility.SalesDocumentNoIsVisible(DocType::"Contract", Rec."No.");
    end;
